...
from utils import train_aligned_parse
...
train_stream = aligned_stream(('train',), args.batch_size)
valid_stream = aligned_stream(('valid',), args.batch_size)
...
cost, extra_updates = parrot.compute_cost(
    features, features_mask, labels, start_flag, args.batch_size)
